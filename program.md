...
- Upstream sync is a separate manual maintenance workflow. Use [`scripts/check_upstream_sync.sh`](scripts/check_upstream_sync.sh) and [`docs/UPSTREAM_SYNC.md`](docs/UPSTREAM_SYNC.md) outside the experiment loop.
